...
namespace MVCTravelBookingISE.Migrations
{
    ...
    [Migration("20221109064609_TripTblUpdated")]
    partial class TripTblUpdated
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MVCTravelBookingISE.Models.TripManagementModel", b =>
                {
                    ...
                    b.Property<int>("BookingAcco_Id")
                        .HasColumnType("int");

                    b.Property<int>("BookingFlight_Id")
                        .HasColumnType("int");

                    b.Property<int>("BookingId")
                        .HasColumnType("int");

                    b.Property<int>("BookingTransport_Id")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MVCTravelBookingISE.Models.TripManagementModel", b =>
                {
                    b.HasOne("MVCTravelBookingISE.Models.FlightBookingItem", "bookedflight")
                        .WithMany("Tripitem")
                        .HasForeignKey("BookingId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MVCTravelBookingISE.Models.TransportBookingItem", "bookedtransport")
                        .WithMany("Tripitem")
                        .HasForeignKey("BookingId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MVCTravelBookingISE.Models.BookingAccoItem", "bookedAcco")
                        .WithMany("Tripitem")
                        .HasForeignKey("Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("bookedAcco");

                    b.Navigation("bookedflight");

                    b.Navigation("bookedtransport");
                });
