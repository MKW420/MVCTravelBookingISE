...
namespace MVCTravelBookingISE.Migrations
{
    ...
    [Migration("20221003090758_Rating_And_Booking_item_Added")]
    partial class Rating_And_Booking_item_Added
    {
            ...
            modelBuilder.Entity("MVCTravelBookingISE.Models.BookingModel", b =>
                {
                    ...
                    b.Property<int?>("TransportModelTransport_Id")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("TransportModelTransport_Id");
            ...
            modelBuilder.Entity("MVCTravelBookingISE.Models.BookingModel", b =>
                {
                    ...
                    b.HasOne("MVCTravelBookingISE.Models.TransportModel", null)
                        .WithMany("Bookings")
                        .HasForeignKey("TransportModelTransport_Id");
                });
